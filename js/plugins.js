...
{"name":"QInput","status":true,"description":"<QInput>\nAdds additional keys to Input class, and allows remapping keys.","parameters":{"Ok":"#enter, #space, #z","Escape / Cancel":"#esc, #insert, #x, #num0","Shift":"#shift, #cancel","Control":"#ctrl, #alt","Tab":"#tab","Pageup":"#pageup, #q","Pagedown":"#pagedown, #w","Left":"#left, #num4","Right":"#right, #num6","Up":"#up, #num8","Down":"#down, #num2","Debug":"#f9","===========":"","FPS":"f2","Streched":"f3","FullScreen":"f4","Restart":"f5","Console":"f8"}},
